...
class Search{
            ...
            this.resultsDiv.html(`
                <div class="row">
                    ...
                    <div class="one-third">
                        ...
                        ${results.generalInfo.length ? '<ul class="link-list min-list">' : '<p>No genral info matches your search</p>'}
                    ...
                    <div class="one-third">
                        ...
                        ${results.professors.length ? '<ul class="professor-cards">' : `<p>No professor matches your search.</p>`}
                    ...
                    <div class="one-third">
                        ...
                        ${results.events.length ? '' : `<p>No program matches your search. <a href="${universityData.root_url}/events">View all events</a></p>`}
    ...
    openOverlay(){
        ...
        // wait 301ms for overlay to showup before focus
        setTimeout(() => {
